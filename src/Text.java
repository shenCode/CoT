...
public class Text {
    ...
    public static final String BACKGROUND_1 =
            ...
            + "on missions too dangerous or difficult " + "\n"
            + "for their own men. " + "\n"
            ...
            + "Whenever you enter a village or town, " + "\n"
    ...
    public static final String BACKGROUND_2 = "One evening, after a " + "\n"
            ...
            + "spices, silks, metalware and " + "\n"
            + "exotic foods from far-off lands." + "\n";
    ...
    public static final String BACKGROUND_3 =
            ...
            + "bolted over them and the doors have " + "\n"
    ...
    public static final String BACKGROUND_4 =
            ...
            + "a single note from a bell rings " + "\n"
            + "out from a tall tower ahead. " + "\n"
            ...
            + "a whisper runs through the " + "\n"
            + "locals as they recognize you - " + "\n"
            ...
            + "but he ignores you and shuffles " + "\n"
            + "over to the great oak door, " + "\n"
    ...
    public static final String BACKGROUND_5 =
            ...
            + "you can see that he is obviously " + "\n"
            + "of some standing in the town, " + "\n"
            + "but his face is full of anguish and sorrow. " + "\n"
            + "Being curious, you decide to hear " + "\n"
            ...
            + "the man leans forward and says, " + "\n"
            + "in a low but anxious voice, " + "\n"
            + "'Stranger, I know of you and seek your aid. " + "\n"
            + "My name is Owen Carralif and I " + "\n"
            + "am the mayor of Silverton. " + "\n"
            + "We are in great trouble and danger. " + "\n"
            + "We are living under a curse " + "\n"
            + "and it is I who must rid us of it. " + "\n"
            ...
            + "with hoods pulled over their faces. " + "\n"
            ...
            + "Zanbar Bone! No doubt you " + "\n"
            + "know what he is the Night Prince. " + "\n"
            ...
            + "I knew then that beneath the " + "\n"
            + "cloaks were hidden the skeletal " + "\n"
    ...
    public static final String BACKGROUND_6 =
            ...
            + "sleep for fear that they might " + "\n"
            + "find a way into our homes. " + "\n"
            + "Some people are now talking of " + "\n"
            + "sending Mirelle to Zanbar Bone. " + "\n"
    ...
    public static final String BACKGROUND_7 =
            ...
            + "You have never wanted anything so"
            + " badly in your life before. " + "\n"
            + "You stand up and hold out your right arm to Owen. " + "\n"
            + "He shakes it eagerly, saying, " + "\n"
            + "'You must set off at the first light of dawn - the "  + "\n"
            + "Moon Dogs will be gone by then. " + "\n"
            + "I shall be forced to stay the night here also, " + "\n"
            + "so let's drink to our destiny and "
    ...
    public static final String STORY1 = "The walk to Port Blacksand " + "\n"
            ...
            + "Eventually you reach the coast " + "\n"
            + "and see the high city wall " + "\n"
