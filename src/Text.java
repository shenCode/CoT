...
public class Text {
    ...
    public static final String BACKGROUND_4 = 
            ...
            + "'The Old Toad' painted on its signboard. As you enter the tavern, "
            + "a whisper runs through the locals as they recognize you - "
            + "some put down their mugs and stare. "
            + "You are somewhat surprised that none come over to you to hear tales of adventure. "
            + "Walking over to the counter you ask the old innkeeper for a room and a hot tub, "
            ...
            + "'That will be five copper pieces for the room and one more for the tub, "
            + "in advance if you please.' "
            + "You reach into a leather pouch on your belt and toss the coins on the counter. "
            + "He hands you an iron key, "
            + "but at the very moment there is a loud knocking at the door followed by a voice shouting, "
            + "'Open up! Open up!' This is Owen Carralif.' "
            + "The old innkeeper shuffles over to the oak door again and slides open the bolts. "
            + "Then a fat and balding man dressed in rich scarlet robes bursts into the tarven, "
            + "looking around frantically. He sees you and walks quickly in your direction, huffing and puffing. "
            + "He is a man certainly not used to haste - "
            + "you notice great beads of sweat on his forehead in the pale candlelight of the room. "
            + "As he nears you, he calls out urgently, 'Stranger, I must speak with you. Please sit down. "
            + "It is important that I speak with you.'";
    
    public static final String BACKGROUND_5 = 
            "When he turns to the innkeeper to snap his fingers for food and drink, "
            ...
            + "bidding you to sit down and the innkeeper bustles in with a tray laden with hot broth, "
            + "roast goose and mead. "
            + "The man in the scarlet robes sits opposite in silence, "
            + "watching you as you feast as though examining you for some purpose of his own. "
            ...
            + "Ten days ago two messengers of evil rode into town on huge black stallions. "
            ...
            + "Their voices were cold and each word spoken ended with an unnerving hiss. "
            + "They asked for me by name and when I came to greet them, "
            + "they wanted to take my beloved daughter Mirelle to stay with their master, "
            + "Zanbar Bone! No doubt you know what he is the Night Prince. "
            + "Of cou9rse I refused their demand and without another word they turned "
            ...
            + "Only a silver arrow through the heart will release those evil beings "
            ...
            + "our troubles began. The Night Prince was angry and determined to harm us. "
            + "Six Moon Dogs came, each stronger than four men, each with razor-sharp fangs. "
    ...
    public static final String BACKGROUND_6 = 
            ...
            + "There is a man called Nicodemus who, for reasons I'll never understand, "
            + "lives in Port Blacksand. The place is commonly called the City of Thieves "
            + "as it is the home of every pirate, brigand, assassin, "
            + "thief and evil-doer for hundreds of miles around. "
            + "I think he lives there just to get some peace from the likes of us. "
            + "He is a wise old wizard and is unlikely to come to much harm even in Port Blacksand, "
    ...
    public static final String BACKGROUND_7 = 
            ...
            + "you are surprised to see a droplet of blood fall from your finger. "
            + "You then examine the marvellously ornate gilded serpents twining round the hilt. "
            + "You have never wanted anything so badly in your life before. "
            + "You stand up and hold out your right arm to Owen. "
            + "He shakes it eagerly, saying, 'You must set off at the first light of dawn - "
    ...
    public static final String BACKGROUND_8 = 
            ...
            + "Later you gather up your backpack and turns and climb the wooden stairs to your room. "
            + "You sleep uneasily despite the security afford by your new broadsword "
            ...
            + "and determined to reach Port Blacksand quickly to find this man Nicodemus. "
            + "As you leave the tavern, "
            + "a black cat scurries past your feet and you almost trip; a bad omen perhaps?'";
}
